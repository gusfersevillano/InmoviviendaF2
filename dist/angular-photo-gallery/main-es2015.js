...
/* harmony import */ var _components_photo_list_photo_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/photo-list/photo-list.component */ "./src/app/components/photo-list/photo-list.component.ts");
...
/* harmony import */ var _components_singup_singup_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/singup/singup.component */ "./src/app/components/singup/singup.component.ts");
/* harmony import */ var _components_singin_singin_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/singin/singin.component */ "./src/app/components/singin/singin.component.ts");
/* harmony import */ var _components_principal_principal_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/principal/principal.component */ "./src/app/components/principal/principal.component.ts");
...
/* harmony import */ var _components_photo_list_photo_list_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/photo-list/photo-list.component */ "./src/app/components/photo-list/photo-list.component.ts");
/* harmony import */ var _components_singup_singup_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/singup/singup.component */ "./src/app/components/singup/singup.component.ts");
/* harmony import */ var _components_singin_singin_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/singin/singin.component */ "./src/app/components/singin/singin.component.ts");
/* harmony import */ var _components_principal_principal_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/principal/principal.component */ "./src/app/components/principal/principal.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _components_photo_list_photo_list_component__WEBPACK_IMPORTED_MODULE_9__["PhotoListComponent"],
            _components_singup_singup_component__WEBPACK_IMPORTED_MODULE_10__["SingupComponent"],
            _components_singin_singin_component__WEBPACK_IMPORTED_MODULE_11__["SinginComponent"],
            _components_principal_principal_component__WEBPACK_IMPORTED_MODULE_12__["PrincipalComponent"]
        ],
        imports: [
...
/* harmony import */ var _service_singup_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../service/singup.service */ "./src/app/service/singup.service.ts");
...
let PhotoFormComponent = class PhotoFormComponent {
    constructor(photoService, router, rutaActiva, activeRoute, UserService) {
    ...
    ngOnInit() {
        this.activeRoute.params.subscribe(params => {
            this.idv = params['idv'];
            this.UserService.getUsuario(this.idv).subscribe(res => { this.user1 = res.username; }, err => console.log(err));
        });
    }
    ...
    uploadPhoto(venta, precio, sector, metros, caracteristicas, vendedor) {
...
PhotoFormComponent.ctorParameters = () => [
...
PhotoFormComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./photo-form.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/photo-form/photo-form.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./photo-form.component.css */ "./src/app/components/photo-form/photo-form.component.css")).default]
    })
], PhotoFormComponent);
...
/* harmony import */ var _service_singup_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../service/singup.service */ "./src/app/service/singup.service.ts");
...
let PhotoListComponent = class PhotoListComponent {
    constructor(photoService, router, activeRoute, UserService) {
        this.photoService = photoService;
        this.router = router;
        this.activeRoute = activeRoute;
        this.UserService = UserService;
    ...
    ngOnInit() {
        this.activeRoute.params.subscribe(params => {
            ...
            this.UserService.getUsuario(this.idv).subscribe(res => { this.user1 = res.username; }, err => console.log(err));
            if (!this.photo) {
                this.photoService.getPhotosV(this.idv).subscribe(res => { this.photos = res; }, err => console.log(err));
            }
        });
    }
    selectedCard(id, idv) {
    ...
    buscarproyectos(transaccion, precio, sector, vendedor) {
        this.activeRoute.params.subscribe(params => {
            this.idv = params['idv'];
            this.photoService.getPhotosVB(this.idv, transaccion.value, precio.value, sector.value).subscribe(res => { this.photos = res; }, err => console.log(err));
...
PhotoListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./photo-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/photo-list/photo-list.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./photo-list.component.css */ "./src/app/components/photo-list/photo-list.component.css")).default]
    })
], PhotoListComponent);
...
let PhotoPreviewComponent = class PhotoPreviewComponent {
    constructor(activeRoute, router, photoService) {
        this.activeRoute = activeRoute;
        this.router = router;
        this.photoService = photoService;
    }
    ngOnInit() {
        this.activeRoute.params.subscribe(params => {
            ...
            this.photoService.getPhoto(this.id).subscribe(res => { this.photo = res; }, err => console.log(err));
        });
    }
    deletePhoto(id) {
        this.activeRoute.params.subscribe(params => {
...
PhotoPreviewComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _services_photo_service__WEBPACK_IMPORTED_MODULE_3__["PhotoService"] }
];
PhotoPreviewComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./photo-preview.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/photo-preview/photo-preview.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./photo-preview.component.css */ "./src/app/components/photo-preview/photo-preview.component.css")).default]
    })
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _service_singup_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../service/singup.service */ "./src/app/service/singup.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
...
let SinginComponent = class SinginComponent {
    constructor(router, UserService, activeRoute, userService) {
        this.router = router;
        this.UserService = UserService;
        this.activeRoute = activeRoute;
        this.userService = userService;
    ...
    signinUser(telefono, password) {
        //console.log(username.value);
        //console.log(telefono.value);
        //console.log(password.value);
        //console.log(description.value);
        this.UserService.signinUser(telefono.value, password.value).subscribe(res => {
            this.user3 = res;
...
SinginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-singin',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./singin.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/singin/singin.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./singin.component.css */ "./src/app/components/singin/singin.component.css")).default]
    })
], SinginComponent);
...
let SingupComponent = class SingupComponent {
    ...
    uploadUser(username, telefono, password) {
        //console.log(username.value);
        //console.log(telefono.value);
        //console.log(password.value);
        //console.log(description.value)
...
let UserService = class UserService {
    ...
    createUser(username, telefono, password) {
    ...
    signinUser(telefono, password) {
        return this.http.post(`${this.URL}api/signin`, { "telefono": telefono, "password": password });
    }
    getUsuario(idv) {
        //console.log(idv);
        return this.http.post(`${this.URL}api/datos${idv}`, { idv });
    }
};
...
let CanvasService = class CanvasService {
    ...
    //#endregion
    drawRect(x, y, width, height, strokeColor = "black", lineWidth = 1, fillColor = "", alpha = 1) {
    ...
    drawLine(x1, y1, x2, y2, color = "black", lineWidth = 1, alpha = 1) {
        var context = this.context;
        context.globalAlpha = alpha;
        context.beginPath();
    ...
    drawCircle(x, y, radius, strokeColor = "black", lineWidth = 1, fillColor = "", alpha = 1) {
        var context = this.context;
        context.beginPath();
        context.lineWidth = lineWidth;
        context.globalAlpha = alpha;
    ...
    drawRectangulo(x, y, width, height, strokeColor = "black", lineWidth = 1, fillColor = "", alpha = 1) {
        var context = this.context;
        context.beginPath();
        context.lineWidth = lineWidth;
        context.globalAlpha = alpha;
    ...
    drawImage(src, x, y, width, height, alpha = 1) {
        var context = this.context;
        var img = new Image();
        img.src = src;
        context.globalAlpha = alpha;
        var img1 = document.getElementById("casa");
        //context.drawImage(img1);    
        img.onload = function () {
            context.drawImage(img, x, y, width, height);
        };
    }
    drawTexto(texto, x, y, fillStyle, font, alpha = 1) {
        var context = this.context;
        context.globalAlpha = alpha;
...
let PhotoService = class PhotoService {
    ...
    createPhoto(venta, precio1, sector, metros, caracteristicas, vendedor, photo) {
        const fd = new FormData();
    ...
    getPhotos() {
        return this.http.get(`${this.URL}api/photos`);
    }
    getPhotosV(vendedor) {
        //return this.http.get<Photo[]>(`${this.UR1}5dcc92cbd23fc6026c6f5d29`);
        return this.http.post(`${this.URL}api/photosV${vendedor}`, { vendedor }); //ojo cambiar cuando ya subas
    }
    getPhotosVB(vendedor, transaccion, precio, sector) {
        //return this.http.get<Photo[]>(`${this.UR1}5dcc92cbd23fc6026c6f5d29`);
        return this.http.post(`${this.URL}api/photosV${vendedor}`, { vendedor, transaccion, precio, sector }); //ojo cambiar cuando ya subas
    }
    getPhoto(id) {
...
module.exports = __webpack_require__(/*! D:\Geobigdata_Proyectos\05_Producción\angular-photo-gallery\src\main.ts */"./src/main.ts");
